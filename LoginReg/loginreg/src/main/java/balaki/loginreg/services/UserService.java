package balaki.loginreg.services;
...
import balaki.loginreg.models.LoginUser;
import balaki.loginreg.models.User;
import balaki.loginreg.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
        ...
        if(userRegistered(newUser.getEmail())){
            result.rejectValue("email", "Email", "Email taking");
            return null;
        }

        // Reject if password doesn't match confirmation
        if(!newUser.getPassword().equals(newUser.getConfirm())){
            result.rejectValue("confirm", "Confirm", "passwords doesn't match");
            return null;
        }
